...
settings = {
    ...
    'mnist': {
        ...
        'subject_path_mrs': os.path.join('test_models', 'mnist_conv_mrs.py'),
        'mutations': ["change_weights_initialisation"] #"[change_label, "delete_training_data", "unbalance_train_data", "add_noise",
    ...
    'lenet': {
        ...
        'mutations': ['change_optimisation_function'] #["remove_validation_set", "change_optimisation_function", "change_loss_function",
    ...
    'movie': {
        ...
        'mutations': ["change_loss_function"] #["change_label", "delete_training_data", "unbalance_train_data", "make_output_classes_overlap",
