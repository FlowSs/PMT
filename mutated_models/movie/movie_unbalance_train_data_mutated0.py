...
def main(model_name, param):
    ...
    if (not os.path.exists(model_location)):
        (x_train, y_train) = training_data_operators.unbalance_training_data(x_train, y_train, param) 
...
if (__name__ == '__main__'):
    ...
    param = [12.5, 21.88, 25, 50]

    for p in param:
     for i in range(200):
          print("Param {}, Model {}".format(p, i))
          mn = 'movie_recomm_unbalance_train_data_mutated0_MP_{}_{}'.format(p, i)
