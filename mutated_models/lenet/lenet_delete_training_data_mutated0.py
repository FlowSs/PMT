...
def main(model_name, param):
    ...
    if (not os.path.exists(model_location)):
        ...
        ([x_img_train, x_ha_train], y_gaze_train) = training_data_operators.operator_delete_training_data([x_img_train, x_ha_train], y_gaze_train, param) #properties.delete_training_data['delete_train_data_pct'])
...
if (__name__ == '__main__'):
    ...
    param = [3.1, 9.29, 12.38, 18.57, 24.75]

    for p in param:
      for i in range(200, 201):
          print("Param {}, Model {}".format(p, i))
          mn = 'lenet_delete_training_data_mutated0_MP_{}_{}.h5'.format(p, i)
