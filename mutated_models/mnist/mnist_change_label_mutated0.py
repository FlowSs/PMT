...
def main(model_name, param):
    ...
    if not os.path.exists(model_location):
        ...
        y_train = training_data_operators.operator_change_labels(y_train, props.change_label['change_label_label'], param) 
...
if (__name__ == '__main__'):
    ...
    param = [3.12, 9.38, 18.75, 28.12, 56.25]
    
    for p in param:
      for i in range(200):
          print("Param {}, Model {}".format(p, i))
          mn = 'mnist_change_label_mutated0_MP_{}_{}.h5'.format(p, i)
