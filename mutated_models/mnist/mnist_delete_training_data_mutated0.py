...
def main(model_name, param):
    ...
    if not os.path.exists(model_location):
        ...
        (x_train, y_train) = training_data_operators.operator_delete_training_data(x_train, y_train, param) 
...
if (__name__ == '__main__'):
    ...
    param = [3.1, 9.29, 12.38, 18.57, 30.93]
    for p in param:
     for i in range(200):
          print("Param {}, Model {}".format(p, i))
          mn = 'mnist_delete_training_data_mutated0_MP_{}_{}.h5'.format(p, i)
